<script lang="ts">
  ...
  import { AXIS_HIPOT } from "../stores/testing";

  import { HEADERS_PROTOCOL, HEADERS_CHARTS, HEADERS_PRESS, HEADERS_POWER } from "../configs/cfg_localization";
  import { COMBOS, transliterate, HEADERS_RESULT} from "../configs/cfg_localization";
  ...
  import TestChart from "./TestChart.svelte";
    import type { ISealtype } from "src/shared/types";
  ...
  const headers_results = {...HEADERS_PRESS[eng], ...HEADERS_POWER[eng], ...HEADERS_RESULT[eng]};
    ...
    <main>
      ...
      <div class="test">
        <div class="test_charts">
          <TestChart bichart titles={chart_titles.power} axies={$AXIS_HIPOT} points={$POINTS_HIPOT} names={power_names}/>
